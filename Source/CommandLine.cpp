...
namespace PeopleNetwork
{
	...
	void CommandLineOptions::Populate(const CommandLine& cmdline)
	{
		...
		OVERRIDE_FROM_CMDLINE_FLG("/Notify-Importance-Stats", NotifyImportanceStats);
		...
		OVERRIDE_FROM_CMDLINE_FLT("/Y-Scale-Factor",          YScaleFactor);
		...
		OVERRIDE_FROM_CMDLINE_STR("/Master-Quit",             MasterQuit);
		OVERRIDE_FROM_CMDLINE_STR("/Symbol-School",           SymbolSchool);
		...
		OVERRIDE_FROM_CMDLINE_INT("/Wrap-Content-Pixels",     WrapContentPixels);
