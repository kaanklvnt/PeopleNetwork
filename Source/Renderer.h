...
namespace PeopleNetwork
{
	...
	private:
		...
		sf::Texture m_TextureSymbolSchool;
		sf::Sprite m_SymbolSchool = sf::Sprite(m_TextureSymbolSchool);
		sf::Text m_SchoolText = sf::Text(m_FontData.Regular);
